...
def run_task2():
    ...
    try:
        ...
        kospi_data = get_intraday_data('^KS11', interval='5m', period='2d').iloc[:-len(kospi_data_today)]
        kosdaq_data = get_intraday_data('^KQ11', interval='5m', period='2d').iloc[:-len(kosdaq_data_today)]
